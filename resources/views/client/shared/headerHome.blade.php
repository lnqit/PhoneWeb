<div class="logonavigation">
	...
	<div class="search">
			<div class="text">
				<input type="" name="" placeholder="Search Keywords">
			</div>
	...
	<div class="by">
		<ul>
			<li class="nav-item"><a class="nav-link" href="{{route('cart.index')}}" title=""><i class="fa fa-shopping-cart"></i> ({{Cart::count()}})</a></>
			@if (Route::has('login'))
			...
			@if (Auth::check())
					...
					<form class="float-right" id="logout-form" action="" method="POST">
					    {{ csrf_field() }}
