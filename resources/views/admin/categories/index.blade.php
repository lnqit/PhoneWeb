 ...
 <div class="container-fluid mt-5">
 	<div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
          <h3 class="m-0 font-weight-bold text-gray-dark">Category List</h3>
        </div>
        <div class="card-body">
                      ...
                      <td>
                      		<a class="btn  float-left" 
                      			href="{{ route('categories.edit',$category->id) }}">
          							...
          							<button type="button" class="btn btn-white ml- deleteUser" data-toggle="modal" data-target="#exampleModalDelete" data-id="{{$category->id}}"><i class="fas fa-trash-alt text-danger"></i></button>
                      </td>
                    </tr>
                    @endforeach
                </tbody>  
...
{{Form::open(['route' => 'categoriesDelete', 'method' => 'POST', 'class'=>'col-md-5'])}}
{{ method_field('DELETE') }}
{{ csrf_field() }}
