...
@section('content')
 <div class="container-fluid mt-5">
    ...
    <div class="card-header py-3">
      <h3 class="m-0 font-weight-bold text-gray-dark">City List</h3>
    </div>
      <div class="card-body ">
                  ...
                  <td class=" text-center">
                      <a class="p-0 ml-2 btn-link btn " 
                         ...
                         <i class="fas fa-edit text-warning"></i>
          						...
          						<button type="button" class="btn btn-white ml- deleteUser" data-toggle="modal" data-target="#exampleModalDelete" data-id="{{$city->id}}"><i class="fas fa-trash-alt text-danger"></i></button>
